...
- Read source-of-truth spec documents (spec.md, plan.md, tasks.md, compliance.md, aria-gate.md, quinn-gate.md in `governance-hub/specs/034-m5-household-roles/`)
...
3. **Bounded and well-defined scope.** Source-of-truth artifacts are fully committed in `governance-hub/specs/034-m5-household-roles/` (spec.md, plan.md, tasks.md, compliance.md, aria-gate.md, quinn-gate.md). Implementation to audit lives on `feat/034-m5-household-roles`. The analysis scope has hard edges.
...
- Read `governance-hub/specs/034-m5-household-roles/spec.md`, `plan.md`, `tasks.md`, `compliance.md`, `aria-gate.md`, `quinn-gate.md`

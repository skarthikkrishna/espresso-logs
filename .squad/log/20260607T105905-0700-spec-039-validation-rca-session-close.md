...
- RCA artifact `.squad/log/20260607T105900-0700-spec-039-validation-rca.md` was written and committed in `d4ac318`.
...
- Decision inbox was checked; processed closeout routing drops were merged into `.squad/decisions/decisions.md` and removed.

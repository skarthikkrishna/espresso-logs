...
When operating on Coffee Tracker UI, defer to `docs/requirements/design-language.md` and
`.squad/skills/ui-design-contract/SKILL.md` over the generic aesthetic guidance below. Use the
spec-030 token/class vocabulary unless Aria reopens the design gate.

/**
 * ToneButton — tone-aware action button with three variants.
 *
 ...
 * `.kk-tc-btn kk-tc-btn--danger`, and `.kk-tc-primary-btn` patterns.
 *
...
type ToneButtonVariant = 'edit' | 'danger' | 'primary'
